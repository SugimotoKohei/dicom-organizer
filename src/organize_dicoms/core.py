...
def file_context(
    ...
    row = {
        ...
        "SequenceName": ds_value(ds, "SequenceName"),
        ...
        summaries.append(
            {
                ...
                "Matrix_RowsxCols": first["Matrix_RowsxCols"],
                "FOV_HxW_mm": first["FOV_HxW_mm"],
                "ImageType": first["ImageType"],
                "MRAcquisitionType": first["MRAcquisitionType"],
                "TR_ms": first["TR_ms"],
                "InversionTime_ms": first["InversionTime_ms"],
                "EchoNumbers": first["EchoNumbers"],
                "EchoTrainLength": first["EchoTrainLength"],
                "NumberOfAverages": first["NumberOfAverages"],
                "AcquisitionMatrix": first["AcquisitionMatrix"],
                "NumberOfPhaseEncodingSteps": first["NumberOfPhaseEncodingSteps"],
                "PercentSampling": first["PercentSampling"],
                "PercentPhaseFOV": first["PercentPhaseFOV"],
                "SAR": first["SAR"],
